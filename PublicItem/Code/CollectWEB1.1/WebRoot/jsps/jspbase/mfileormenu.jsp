				...
				<div class="addfile">
					<div class="modal-body">
						<div class="form-group row">
							<div class="logoclass pull-right" style="padding-left: 0px;"><img id="_logo" src="" class="img-responsive" style="max-width: 26;
    height: 26;margin-top: 3px;"></div>
							<div class="col-sm-11" style="padding-left:0px;padding-right: 0px;">
							
							<input class="form-control" id="_url" placeholder="URL"></input>
							</div>
						</div>
						<div class="form-group">
							<input class="form-control" id="_title" placeholder="Title"></input>
							<input type="hidden" id="_typelist"></input>
						</div>
					</div>
